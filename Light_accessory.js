...
var options = {
  port: 1883,
  host: '192.168.2.103',
  clientId: 'ESP8266_LED'
};
var client = mqtt.connect(options);
console.log("ESP8266_LED Connected to MQTT broker");
...
var lightUUID = uuid.generate('hap-nodejs:accessories:ESP8266_LED');
...
light
  .addService(Service.Lightbulb, "ESP8266_LED") // services exposed to the user should have "names" like "Fake Light" for us
